...
import { getAutores, postAutor, updateAutor,deleteAutor } from '../../../services/biblioteca.services/autor.service';
            ...
            <ul>
                {autores.map(autor => (
                    <li key={autor.Codigo}>
                        ...
                        <button onClick={() => handleEliminar(autor.Codigo)}>Eliminar</button>
                    </li>
                ))}
            </ul>
        </div>
