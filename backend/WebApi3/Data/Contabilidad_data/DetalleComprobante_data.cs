...
{
    public class DetalleComprobante_data
    {
        private static readonly string baseDatos = "contabilidad";

        //Insertar Detalle
        public static bool InsertarDetalle(DetalleComprobante_models Detalle)
        {
        ...
        public static List<DetalleComprobante_models> ConsultarDetalles()
        {
            using SqlConnection conexion = ConnGeneral.ObtenerConexion(baseDatos);
            conexion.Open();
            ...
            List<DetalleComprobante_models> lista = [];
            while (reader.Read())
            {
                DetalleComprobante_models detalle = new()
                {
        ...
        public static DetalleComprobante_models? ConsultarDetalle(int codigo)
        {
            using SqlConnection conexion = ConnGeneral.ObtenerConexion(baseDatos);
            conexion.Open();
            ...
            if (reader.Read())
            {
                return new DetalleComprobante_models()
                {
        ...
        public static List<DetalleComprobante_models> ObtenerDetalles(int numero)
        {
            using SqlConnection conexion = ConnGeneral.ObtenerConexion(baseDatos);
            conexion.Open();
        ...
        //Actualizar Detalle
        public static bool ActualizarDetalle(int codigo, DetalleComprobante_models Detalle)
        {
            using SqlConnection conexion = ConnGeneral.ObtenerConexion(baseDatos);
            conexion.Open();
        ...
        //Buscar Detalle
        public static List<DetalleComprobante_models> BuscarDetalle(int? haber = null, string? cuenta = null, int? debe = null)
        {
            try
            {
                using SqlConnection conexion = ConnGeneral.ObtenerConexion(baseDatos);
