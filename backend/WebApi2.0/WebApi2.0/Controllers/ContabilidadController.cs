...
namespace WebApi2._0.Controllers
{
    ...
    public class ContabilidadController(AppDbContext context) : Controller
    {
        ...
        public List<Detalle_comprobante_models> GetDetalle_Comprobantes()
        {
            return Detalle_comporbante_data.ConsultarDetalles();
        }
        ...
        public List<Detalle_comprobante_models> GetObtener_Comprobante(int id)
        {
            return Detalle_comporbante_data.ObtenerDetalles(id);
        }
        ...
        public IActionResult GetBuscarDetalle([FromQuery] int? debe = null, [FromQuery] string? cuenta = null, [FromQuery] int? haber = null)
        {
            ...
            {
                // Llamada al método de datos con los parámetros proporcionados.
                var resultados = Detalle_comporbante_data.BuscarDetalle(haber, cuenta, debe);
        ...
        public bool PostDetalle_Comprobante([FromBody] Detalle_comprobante_models ODetalle)
        {
            return Detalle_comporbante_data.InsertarDetalle(ODetalle);
        }

        //PUT: api/comprobante/5
        [HttpPut("detalle_comprobante/{id}")]
        public IActionResult PutDetalle_Comprobante(int id, [FromBody] Detalle_comprobante_models ODetalle)
        {
            try
            {
                // Validación del ID: debe ser un número positivo
                ...
                bool actualizado = Detalle_comporbante_data.ActualizarDetalle(id, ODetalle);
